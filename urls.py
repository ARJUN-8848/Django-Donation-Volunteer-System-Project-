"""
URL configuration for doenv project.
...
from app.views import SignupVolunteerView 
urlpatterns = [
    ...
    path("signup-volunteer/", SignupVolunteerView.as_view(), name="signup_volunteer"),
    ...
    path(
        "donationnotrec-admin/",
        views.donationnotrec_admin,
